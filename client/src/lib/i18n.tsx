...
const translations = {
  en: {
    ...
    registerUsernameHint: "At least 3 characters",
    ...
    loginRequiredGoToLogin: "Go to Login",
    loginRequiredRegisterNow: "Register Now",
    loginRequiredBackToHome: "Back to Home",
    portfoliosTitle: "My Portfolios",
    portfoliosCancel: "Cancel",
    portfoliosCreate: "Create Portfolio",
    portfoliosCreateNew: "Create New Portfolio",
    portfoliosName: "Portfolio Name",
    portfoliosNamePlaceholder: "e.g., AI Stock Strategy",
    portfoliosInitialCash: "Initial Cash ($)",
    portfoliosType: "Type",
    portfoliosLiveTrading: "Live Trading",
    portfoliosBacktest: "Backtest",
    portfoliosCreating: "Creating...",
    portfoliosCreateSubmit: "Create",
    portfoliosLoading: "Loading portfolios...",
    portfoliosEmpty: "No portfolios yet",
    portfoliosCreateFirst: "Create your first portfolio",
    portfoliosTypeLabel: "Type",
    portfoliosInitialLabel: "Initial",
    portfoliosCurrentValueLabel: "Current Value",
    portfoliosViewDetails: "View Details",
    indicator: {
      rsi: {
  ...
  zh: {
    ...
    unknownIndicatorInterpretation: "查阅金融资源以获取详细解释。",
    authAppName: "股票看板",
    authUsername: "用户名",
    authEmail: "邮箱",
    authPassword: "密码",
    ...
    registerPasswordTooShort: "密码至少 6 个字符",
    registerUsernameTooShort: "用户名至少 3 个字符",
    registerSubmitting: "创建账号中...",
    registerSubmit: "创建账号",
    registerHasAccount: "已有账号？",
    registerLogin: "登录",
    loginRequiredTitle: "需要登录",
    loginRequiredDescription: "请先登录后再访问此页面。如果还没有账号，可以免费注册。",
    loginRequiredGoToLogin: "去登录",
    loginRequiredRegisterNow: "立即注册",
    loginRequiredBackToHome: "返回首页",
    portfoliosTitle: "我的组合",
    portfoliosCancel: "取消",
    portfoliosCreate: "创建组合",
    portfoliosCreateNew: "新建组合",
    portfoliosName: "组合名称",
    portfoliosNamePlaceholder: "例如：AI 股票策略",
    portfoliosInitialCash: "初始资金（$）",
    portfoliosType: "类型",
    portfoliosLiveTrading: "模拟交易",
    portfoliosBacktest: "回测",
    portfoliosCreating: "创建中...",
    portfoliosCreateSubmit: "创建",
    portfoliosLoading: "正在加载组合...",
    portfoliosEmpty: "暂无组合",
    portfoliosCreateFirst: "创建你的第一个组合",
    portfoliosTypeLabel: "类型",
    portfoliosInitialLabel: "初始资金",
    portfoliosCurrentValueLabel: "当前市值",
    portfoliosViewDetails: "查看详情",
    indicator: {
      rsi: {
        title: "RSI（相对强弱指标）",
