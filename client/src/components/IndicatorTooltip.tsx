...
const INDICATOR_EXPLANATIONS: Record<string, { title: string; description: string; interpretation: string }> = {
  ...
  shortFloat: {
    title: "Short Float %",
    description: "The percentage of a company's shares available for public trading (float) that have been sold short but not yet covered. Represents bearish bets against the stock.",
    interpretation: "Short Float < 10% = Low bearish interest\nShort Float 10-20% = Moderate short interest\nShort Float 20%+ = High short interest (crowded short, squeeze risk)\nHigher % = More bearish sentiment, but also higher squeeze potential"
  },
  macd: {
  ...
  predictedReturn: {
    ...
    description: "Forecasted price return over the next 20 trading days (approximately 1 month), generated by machine learning models analyzing historical price patterns and technical factors.",
    interpretation: "Positive % = Bullish signal (expected price increase)\nNegative % = Bearish signal (expected price decrease)\n> 5% = Strong upside potential\n< -5% = Strong downside risk\nBased on historical patterns and current technical indicators"
  },
  vol60: {
